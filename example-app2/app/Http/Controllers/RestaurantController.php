...
class RestaurantController extends Controller
{
    ...
    $food->save();
    return redirect(route('addFood'))->with('success', 'success');
    ...
    public function insertCategory(Request $request)
    {
        ...
        return redirect(route('addCategory'))->with('success', 'success');
    }
    ...
    public function updateRestaurantInfo(Request $request)
    {
        ...
        $restaurant->save();
        return redirect(route('editUserInfo'))->with('success' , 'success');
    }
