...
class basketController extends Controller
{
    public function add($foods_id)
    {
        ...
        return redirect(route('user'))->with('success','محصول با موفقیت به سبد خرید اضافه شد');
    ...
    public function deleteOrder($id)
    {
         ...
         return redirect(route('foodBasket'))->with('success','محصول با موفقیت از سبد خرید حذف شد');
    ...
    {  
        ...
        $basket->is_payed = 1;
        $basket->save();
        return redirect(route('profile'))->with('success', ' سفارش در حال آماده سازی است . سفارش شما با موفقیت ثبت شد');
    }
