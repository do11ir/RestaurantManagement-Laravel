...
class HomeController extends Controller
{
    public function user()
    {
        ...
        return view('index' , ['food' => $food , 'category' => $category , 'Basket' => $Basket , 'restaurant'=>$restaurant]);
            ...
            return view('index' , ['food' => $food , 'restaurant' => $restaurant] );
        }
  ...
  public function editUserInfo()
{
    ...
    public function updateUserInfo(Request $request)
    {
        ...
        $user->update();
        return redirect(route('profile'))->with('success', 'اطلاعات با موفقیت ویرایش شد.'); 
    }
    ...
    public function deleteAddress($id)
    {
        ...
        return redirect(route('profile'))->with('success', ' آدرس با موفقیت حذف شد.'); 
    }
