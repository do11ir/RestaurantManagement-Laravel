...
class AdminController extends Controller
{
    ...
    {
        return view("AdminPannel.AdminPannel");
    }
    ...
    { 
            ...
            return redirect(route('restaurantManage'))->with('success', ' رستوران با موفقیت حذف شد.'); 
    }
    ...
    public function updateRestaurants(Request $request)
    {
        ...
        $restaurant->save();
        return redirect(route('restaurantManage'))->with('success', ' رستوران با موفقیت ویرایش شد.');
    }
    ...
    $food->save();
    return redirect(route('foodManage'))->with('success', 'غذا با موفقیت ثبت شد.');
    }
    ...
    public function updateFoodAdmin(Request $request)
    {
        ...
        return redirect()->back()->with('success', 'غذا با موفقیت ویرایش شد.'); 
    }
    ...
    public function insertUser(Request $request)
    {
        ...
        return redirect()->route('userManage')->with('success', 'کاربر جدید با موفقیت ثبت شد.');
    }
    ...
    public function deleteUser($id)
    {
        ...
        return redirect(route('userManage'))->with('success', 'کاربر با موفقیت حذف شد');
    }
    ...
    public function updateUser(Request $request)
    {
        ...
        $user->save();
        return redirect()->route('userManage')->with('success', 'کاربر با موفقیت ویرایش شد');
    ...
    public function insertCategoryAdmin(Request $request)
    {
        ...
        return redirect(route('categoryManage'))->with('success', 'دسته بندی با موفقیت اضافه شد');
    }

    public function deleteCategoryAdmin($id)
    {
        category::find($id)->delete();
        return redirect(route('categoryManage'))->with('success', 'دسته بندی با موفقیت حذف شد.'); 
    }
    ...
    public function updateCategoryAdmin(Request $request)
    {
        ...
        $category->save();
        return redirect(route('categoryManage'))->with('success', 'دسته بندی با موفقیت ویرایش شد.'); 
    }
    ...
    public function deleteFactorAdmin($id)
    {
        ...
        return redirect()->back()->with('success', 'فاکتور با موفقیت حذف شد');
    }
